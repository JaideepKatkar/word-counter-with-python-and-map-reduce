...
text_files = glob.glob('C:\\Temp\\arq_exerc\\join\\*')
...
def mapfn(k, v):
    ...
    for line in v.splitlines():
        if k == 'C:\\Temp\\arq_exerc\\join\\2.2-vendas.csv':
            yield line.split(';')[0], 'Vendas' + ':' + line.split(';')[5]
        if k == 'C:\\Temp\\arq_exerc\\join\\2.2-filiais.csv':
...
w = csv.writer(open("C:\\Temp\\arq_exerc\\result3.csv", "w"))
